...
def _intraday_story_event(record: dict, parsed: dict, context: dict) -> dict:
    ...
    for row in deterministic_levels:
        ...
        level_reads.append({
            ...
            "distance_to_zone": row.get("distance_to_zone"),
            "distance_to_low_boundary": row.get("distance_to_low_boundary"),
            "distance_to_high_boundary": row.get("distance_to_high_boundary"),
            "boundary_semantics": row.get("boundary_semantics"),
